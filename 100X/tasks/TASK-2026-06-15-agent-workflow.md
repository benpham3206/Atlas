...
- Add portable shared skills under `100X/agents/skills`.
- Add per-task templates for `100X/tasks/`, `100X/state/`, and `100X/logs/`.
...
- [x] `100X/docs/AGENT_WORKFLOW.md` documents the Poke -> Cursor -> Codex workflow and security gates.
- [x] `100X/cursor/rules` and `100X/cursor/agents` define focused Cursor behavior without symlinking `AGENTS.md`.
- [x] `100X/agents/skills` defines reusable planning, implementation, review, and handoff skills.
- [x] `100X/tasks/`, `100X/state/`, and `100X/logs/` include templates for future per-task handoffs.
- [x] Root `100X/STATE.md`, `100X/LOGS.md`, and `100X/POKE_SUMMARY.md` are short summaries that do not replace `TASKS.md` or `CONTEXT_LOG.md`.
...
- `100X/agents/skills/**/SKILL.md`
- `100X/cursor/rules/*.mdc`
- `100X/cursor/agents/*.md`
- `100X/tasks/`
- `100X/state/`
- `100X/logs/`
- `scripts/lint.js`
