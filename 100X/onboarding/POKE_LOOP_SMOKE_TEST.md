...
Poke
  ...
  -> branch + docs-only PR + 100X/POKE_SUMMARY.md
  -> local Cursor Codex plugin review
  -> Poke/Cursor Cloud fix follow-up
  -> updated 100X/POKE_SUMMARY.md
```
...
Output: 100X/tasks/TASK-2026-06-15-poke-smoke-test.md and a Cursor Cloud launch prompt for Poke.
...
- Cursor Cloud updates `100X/POKE_SUMMARY.md`.
...
Reply with the branch, PR, commands run, current phase, risks, and the latest 100X/POKE_SUMMARY.md text.
```
...
Use 100X/POKE_SUMMARY.md and 100X/logs/TASK-2026-06-15-poke-smoke-test.md.
```
...
- `100X/POKE_SUMMARY.md` reflects the final state.
