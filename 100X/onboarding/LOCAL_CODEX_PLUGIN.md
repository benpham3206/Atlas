...
- relevant `100X/tasks/<TASK_ID>.md`
...
- Codex reviews the branch or PR diff against `AGENTS.md`, `100X/docs/AGENT_WORKFLOW.md`, and the task
  spec.
...
```text
Summarize the current PR using 100X/POKE_SUMMARY.md, 100X/logs/<TASK_ID>.md, and the latest verification
